  ...
  style='cursor:pointer;'/>`;
      ...
      id='but3${id}' style='cursor:pointer;'/>`;
                ...
                Promise.all(team_ids_ret.map(teamId => fetchTeamLoyalAndRetiring(teamId))) .then(results => {
                    document.getElementById("hp_loader_loyals").remove()
                }).catch(err => {
                    document.getElementById("hp_loader_loyals").remove()
                });
...
<div style="margin: 0 auto; text-align:center;">
 ...
 <label class="stx-checkitem" style="justify-content: center;"><input type="checkbox" id="monitoredTeamsNotify" ${checked}> Notifications</label>
 </div>
...
<div style="padding:4px 4px 6px;font-family:sans-serif;">
  ...
  `;
    ...
    <h3 style="position: relative; margin: 0 auto;">NT Player</h3>
