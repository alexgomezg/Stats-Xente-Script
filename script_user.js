...
.expandable-item.active .expandable-icon{
  ...
  `)
    ...
    setTimeout(function () {
        ...
        if((urlParams.has('p')) && (urlParams.get('p') === 'players')&&(!urlParams.has('pid')) &&(GM_getValue("playersFlag"))){
            playersPage()
        }
        ...
        if((urlParams.has('p')) && (urlParams.get('p') === 'friendlyseries')&&(urlParams.get('sub') === 'standings')){
